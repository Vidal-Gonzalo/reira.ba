        ...
        <div className="container">
            <div className="wrap-buttons">
                ...
                <div className="buy-button">
                    {
                        !bought ? <button className="buy-button btn btn-info" onClick={() => setBought(true)}>Agregar al carrito</button> : <div className="purchased"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-check" viewBox="0 0 16 16">
